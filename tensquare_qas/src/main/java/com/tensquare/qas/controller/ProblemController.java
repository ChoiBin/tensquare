...
import com.tensquare.qas.service.ProblemService;
...
public class ProblemController {
	...
	@RequestMapping(value = "/hotlist/{labeidl}/{page}/{size}",method = RequestMethod.GET)
	...
	@RequestMapping(value = "/waitlist/{labeidl}/{page}/{size}",method = RequestMethod.GET)
